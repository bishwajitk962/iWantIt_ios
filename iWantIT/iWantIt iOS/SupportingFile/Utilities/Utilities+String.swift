...
extension String {
    ...
    func isValidUsername() -> Bool {
            // Regular expression to check for username format
    ...
    func isValid_PhoneNumber() -> Bool {
        // Regular expression to check for phone number format
        let phoneRegex = "^\\d{10}$" // Change this regex according to your phone number format
